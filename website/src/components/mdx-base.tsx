...
/**
 * Styling for rendered Markdown, without the code-block renderer. That one
 * pulls in syntax highlighting and diagrams (a few hundred KB), so it is added
 * only where code appears: the docs (mdx-components.tsx).
 */
