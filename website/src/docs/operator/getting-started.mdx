...
- **Route outbound requests anonymously** through a local Anyone client (SOCKS5 proxy)
...
8. Installs the Anyone client (SOCKS5 proxy on port 9050, used for `/v1/proxy/anon`)
