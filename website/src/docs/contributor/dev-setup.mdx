...
# The main CLI binary is built from cmd/orama/
...
|--------|-------------|---------|
| `orama` | `cmd/orama/` | CLI tool for all operations |
| `pubsub` | `cmd/pubsub/` | Namespace gossipsub HTTP API |
...
network/
  core/          # Go network services + CLI (the Go module root)
    ...
    pkg/         # All Go packages
      ...
      anonproxy/ # Tor SOCKS5 dialer (anonymity proxy)
    sdk/         # Go function SDK
