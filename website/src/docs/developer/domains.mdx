...
5. No certificate is issued for custom domains yet: HTTPS works on your deployment's address under the network's own domain, and a custom domain is served over HTTP until custom-domain certificates land
